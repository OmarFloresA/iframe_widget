...
import { RecipientsListPopover } from '@web_chatter_position/core/recipients_popover/recipients_popover';

export class RecipientsList extends Component {
    static template = 'web_chatter_position.BaseRecipientsList';
    static props = {
        thread: { type: Object },
