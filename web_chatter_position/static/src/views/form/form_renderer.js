...
patch(FormRenderer.prototype, {
    setup() {
        ...
        this.chatterState = useState({
            width: browser.localStorage.getItem('web_chatter_position.width'),
        });
    ...
    onStartChatterResize(ev) {
        ...
        const resizePanel = (ev) => {
            ...
            browser.localStorage.setItem('web_chatter_position.width', newWidth);
    ...
    onDoubleClickChatterResize(ev) {
    	browser.localStorage.removeItem('web_chatter_position.width');
